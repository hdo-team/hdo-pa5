...
public class ClientExample {
	...
	public static void main(String[] args) {
		...
		ClientExample db = null;

		try {
			db = new ClientExample("C:/temp/db_file");
		} catch (Exception ex1) {
		...
		try {
			...
			db.update("UPDATE sample_table SET str_col = 'Ford'  WHERE num_col > 200");
			...
			// do a query
			db.query("SELECT * FROM sample_table WHERE num_col > 150");
